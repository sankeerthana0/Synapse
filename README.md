...
```text
Synapse-AI-Intelligence-System/
│── assets/
│   ├── multi-agent-threat-orchestration.png
│   ├── rag-context-alerting-pipeline.png
│   └── fastapi-intelligence-endpoints.png
│
│── agents/
│── rag/
│── vector_db/
...
**Synapse: AI-Powered Multi-Agent Intelligence System** | LangGraph · FAISS · RAG · FastAPI · ChromaDB  
Built a multi-agent cybersecurity intelligence system orchestrated with LangGraph that ingests threat reports and telemetry, retrieves contextual intelligence through FAISS/ChromaDB-based RAG, routes findings across specialized agents (analysis, summarization, alerting), and exposes monitoring-ready workflows via FastAPI endpoints.
